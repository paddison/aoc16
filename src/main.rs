...
fn main() {
    ...
    let start = Instant::now();
    let result = 22429;// this takes too long d14::get_solution_2();
    ...
    let start = Instant::now();
    let result = d15::get_solution_2();// this takes too long d14::get_solution_2();
    ...
    let start = Instant::now();
    let result = d16::get_solution_2();// this takes too long d14::get_solution_2();
    ...
    println!("Day  19.1\t{}us\t\t{}", start.elapsed().as_micros(), result);

    let start = Instant::now();
    let result = d19::get_solution_2();// this takes too long d14::get_solution_2();
    println!("Day  19.2\t{}us\t\t{}", start.elapsed().as_micros(), result);
    ...
    let start = Instant::now();
    let result = d20::get_solution_2();// this takes too long d14::get_solution_2();
    println!("Day  20.2\t{}us\t\t{}", start.elapsed().as_micros(), result);

    let start = Instant::now();
    let result = d21::get_solution_1();
    println!("Day  21.1\t{}us\t\t{}", start.elapsed().as_micros(), result);

    let start = Instant::now();
    let result = d21::get_solution_2();// this takes too long d14::get_solution_2();
    ...
    let start = Instant::now();
    let result = d22::get_solution_2();// this takes too long d14::get_solution_2();
    println!("Day  22.2\t{}us\t\t{}", start.elapsed().as_micros(), result);

    let start = Instant::now();
    let result = d23::get_solution_1();
    println!("Day  23.1\t{}us\t\t{}", start.elapsed().as_micros(), result);

    let start = Instant::now();
    let result = d23::get_solution_2();// this takes too long d14::get_solution_2();
